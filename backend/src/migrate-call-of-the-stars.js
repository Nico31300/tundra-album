...
const puzzle = db.prepare("SELECT * FROM puzzles WHERE name = 'Call of the Stars'").get();
if (!puzzle) {
  console.log('Puzzle "Call of the Stars" not found.');
  process.exit(1);
}
...
console.log(`Added ${added} piece(s) to "Call of the Stars" (now 18 total).`);
